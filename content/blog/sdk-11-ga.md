...
- **For the SDK:** [titaniumsdk.com/docs/sdk/11.0.0/release-notes](/docs/sdk/11.0.0/release-notes)
...
If you’re new to Titanium and are installing this for the first time, we encourage you to review our new user setup process by [clicking here](/docs/build).
